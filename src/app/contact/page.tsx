...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const messageText = `Hello Sneha Salon & Spa! I'd like to book an appointment / send an inquiry:\n\n` +
      `*Name:* ${formData.name}\n` +
    ...
    const whatsappUrl = `https://wa.me/917681859504?text=${encodeURIComponent(messageText)}`;

    // Open WhatsApp in a new tab
    window.open(whatsappUrl, "_blank", "noopener,noreferrer");

    // Simulate completion of UI state
    setTimeout(() => {
          ...
          <div className={styles.contactGrid}>
            ...
            <div className={`${styles.contactInfo} animate-on-scroll`}>
              ...
              <div className={styles.infoList}>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div className={styles.infoContent}>
                    <h4>Call Us</h4>
                    <p>
                      <a href="tel:+917681859504">+91 76818 59504</a><br/>
                      <a href="tel:+918118019300">+91 81180 19300</a>
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.infoItem}>
                  ...
                  <div className={styles.infoContent}>
                    <h4>WhatsApp</h4>
                    <p>
                      <a href="https://wa.me/917681859504" target="_blank" rel="noopener noreferrer">+91 76818 59504</a><br/>
                      <a href="https://wa.me/918118019300" target="_blank" rel="noopener noreferrer">+91 81180 19300</a>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={styles.socialLinks}>
                <a href="https://www.facebook.com/share/v/18eotFqmcK/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className={`${styles.socialIcon} ${styles.socialIconFacebook}`} aria-label="Facebook"><FacebookIcon /></a>
                <a href="https://www.instagram.com/_sneha_salon_spa?utm_source=qr&igsh=MTc1ZHppM2FsNHRtdQ==" target="_blank" rel="noopener noreferrer" className={`${styles.socialIcon} ${styles.socialIconInstagram}`} aria-label="Instagram"><InstagramIcon /></a>
              </div>

              <div className={styles.miniMap}>
                <iframe 
                  src="https://maps.google.com/maps?q=20.482124,85.814163&t=&z=17&ie=UTF8&iwloc=&output=embed" 
                  allowFullScreen 
                  loading="lazy" 
